...
Negotiator._makeOffer = function(connection) {
  ...
  pc.createOffer(function(offer) {
    ...
    if(connection.type === 'media') {
      offer.sdp = setBandwidth(offer.sdp, connection.localStream.bandwidth);
    }
...
Negotiator._makeAnswer = function(connection) {
  ...
  pc.createAnswer(function(answer) {
    ...
    if(connection.type === 'media') {
      answer.sdp = setBandwidth(answer.sdp, connection.localStream.bandwidth);
    }
...
function setBandwidth(sdp, bandwidth) {
  var videoBandwidth = bandwidth[0];
  var audioBandwidth = bandwidth[1];
  if(videoBandwidth !== undefined) { sdp = sdp.replace(/a=mid:video\r\n/g, 'a=mid:video\r\nb=AS:' + videoBandwidth + '\r\n'); }
  if(audioBandwidth !== undefined) { sdp = sdp.replace(/a=mid:audio\r\n/g, 'a=mid:audio\r\nb=AS:' + audioBandwidth + '\r\n'); }
  return sdp;
}
